...
const Reviews = () => {
  const reviewsData = [
    {
      id: 1,
      text: '«Отримані результати стали цінним інструментом… Кожен учасник також відзначив, що отримав багато корисної, практичної інформації для себе особисто — про власний стан, способи відновлення та підтримку емоційної рівноваги.»',
      author: 'БО «100% Життя»'
    },
    {
      id: 2,
      ...
      author: 'ГО «Серце Азовсталі»'
    },
    {
      id: 3,
      text: '«Учасникам цікаво брати участь у "емоційних чек-інах", для них це навіть трохи схоже на гру, у якій можна бачити власну динаміку і результати.»',
      author: 'Фонд Олени Пінчук — Ярослава Кот-Миронова'
    },
    {
      id: 4,
      text: '«Це допомагає вчасно відреагувати на ті аспекти, які найбільше дисбалансують учасниць, та допомогти їм краще впоратися зі стресом.»',
